import type { ClaudeMdFile, Rule } from "../types.js";
...
function hasOpposingTerms(a: string, b: string): boolean {
...
function prefilterPairs(rules: Rule[]): [Rule, Rule][] {
  const scored: Array<{ pair: [Rule, Rule]; score: number }> = [];
